...
import InfoIcono from "../../../../helpers/visuales/DatoTituloIcono";
  ...
  return (
    <div className="tw-my-6 tw-space-y-4">
      <div className="tw-grid tw-grid-cols-2 tw-gap-3">
        <InfoIcono
          icon={<FaTicket className="tw-text-pink-400 tw-text-[1.2rem]" />}
          title="Entrada"
        ...
        <InfoIcono
          ...
          title="Entrada"
          value={destino.reserva.entrada}
        />
        <InfoIcono
          icon={<FaCalendarAlt className="tw-text-cyan-500 tw-text-[1.2rem]" />}
          title="Cancelación SC"
          value={destino.reserva.cancelacionGratis}
        />
      </div>
