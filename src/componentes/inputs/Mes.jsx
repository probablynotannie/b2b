    ...
    <div>
      <DatesProvider settings={{ locale: "es" }}>
        <div className="tw-relative">
          ...
          />
          <div className="tw-absolute tw-top-0 tw-pointer-events-none tw-tw-bg-inputIcon tw-text-white tw-h-full tw-rounded-tl-lg tw-rounded-bl-lg tw-flex tw-items-center tw-justify-center tw-w-8 tw-text-xl dark:tw-bg-slate-800 dark:tw-border-slate-600 dark:tw-border-y-2 dark:tw-border-l-2">
            <FaCalendarAlt />
          </div>
        </div>
      </DatesProvider>
