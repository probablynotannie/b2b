...
const InputNacionalidad = ({ value, setValue }) => {
  ...
  return (
    <div className="tw-relative tw-text-black">
      ...
      <div className="tw-absolute dark:tw-bg-slate-800 dark:tw-border-slate-600 dark:tw-border-y-2 dark:tw-border-l-2 tw-top-0 tw-pointer-events-none bg-inputIcon tw-text-white tw-h-full tw-rounded-tl-lg tw-rounded-bl-lg tw-flex tw-items-center tw-justify-center tw-w-8 tw-text-xl">
        <FaGlobe />
      </div>
    </div>
  );
