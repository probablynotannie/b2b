  ...
  return (
    <Popover
      ...
      content={
        <div className="w-96 text-sm text-gray-500 dark:text-gray-400">
          ...
          <div className="flex h-full flex-col justify-between py-2 pr-1 px-3">
              ...
              <div className="grid grid-cols-1 gap-1">
                {Array.from({ length: habitacion }).map((_, roomIndex) => (
                  <div key={roomIndex}>
                    <Popover
                      ...
                      content={
                        <div className="w-64 text-sm text-gray-500 dark:text-gray-400">
                          <div className="bg-secondary text-white h-14 flex items-center pl-4 font-semibold">
                            Adultos / Niños
                          </div>
                          <div className="px-3 py-2">
                            <div key={roomIndex} className="py-2">
                    ...
                    >
                      <div className="text-primary border-primary border mt-1 p-3 py-5 rounded-lg font-semibold">
                        {`Habitación ${roomIndex + 1}: ${
                          roomData[roomIndex].adultos
                        } adultos, ${roomData[roomIndex].ninios} niños`}
                      </div>
                    </Popover>
                  </div>
                ))}
    ...
    >
      <div className="relative w-full">
        ...
        >
          {habitacion} hab{" "}
          {roomData.reduce((sum, room) => sum + room.adultos, 0)} adultos{" "}
          {roomData.reduce((sum, room) => sum + room.ninios, 0)} niños
        </div>
      </div>
    </Popover>
  );
