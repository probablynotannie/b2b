...
function Clientes() {
  return (
    <div className="tw-grid tw-grid-cols-7 tw-gap-10 md:tw-px-20 lg:tw-min-h-[78vh] tw-min-h-[90vh] md:tw-py-10">
      <Sidebar />
      <div className="tw-relative tw-p-5 tw-col-span-7 lg:tw-col-span-5 xl:tw-col-span-6 tw-min-h-[68vh] md:tw-rounded-lg md:tw-shadow-lg tw-bg-slate-200 dark:tw-bg-slate-900">
        <h2 className="tw-text-2xl tw-font-semibold dark:tw-text-white">
          Listado de clientes
        </h2>
        <span className="tw-text-slate-400">Cartera clientes de agencia</span>
        <div className="tw-space-x-3 tw-border-t-2 tw-border-secondary tw-pt-5 tw-mt-3">
          <button className="tw-btn_accesorios tw-btn_primario tw-smooth dark:tw-btn_oscuro">
            Excel
          </button>
          <button className="tw-btn_accesorios tw-btn_primario tw-smooth dark:tw-btn_oscuro">
            Nuevo
          ...
          <div>
            ...
            <div className="tw-relative">
              ...
              <input
                type="search"
                id="default-search"
                className="tw-block tw-w-full tw-h-[40px] tw-ps-10 tw-text-sm tw-text-gray-900 tw-border tw-border-gray-300 tw-rounded-lg tw-bg-gray-50 focus:tw-ring-blue-500 focus:tw-border-blue-500 dark:tw-bg-gray-700 dark:tw-border-gray-600 dark:placeholder-gray-400 dark:tw-text-white dark:focus:tw-ring-blue-500 dark:focus:tw-border-blue-500"
                placeholder="Buscador de ..."
                required
              />
              <button
                type="submit"
                className="tw-text-white tw-absolute tw-end-0 tw-bottom-0 tw-bg-slate-800 tw-font-medium tw-rounded-r-lg tw-text-sm tw-px-4 tw-h-full"
              >
                Buscar
              </button>
            </div>
