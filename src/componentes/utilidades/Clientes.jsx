        ...
        <div className="mt-5">
          <div>
            <label
              ...
              className="mb-2 text-sm font-medium text-gray-900 sr-only dark:tw-text-white"
            >
              Search
            </label>
            <div className="relative">
              ...
              <input
                type="search"
                id="default-search"
                className="block w-full p-2.5 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:tw-border-gray-600 dark:placeholder-gray-400 dark:tw-text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
