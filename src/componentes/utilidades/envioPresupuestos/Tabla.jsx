      ...
      <div className="tw-hidden md:tw-flex tw-relative tw-overflow-x-auto tw-shadow-md sm:tw-rounded-lg tw-mt-5">
        <table className="tw-w-full tw-text-sm tw-text-left rtl:tw-text-right tw-text-slate-600 dark:tw-text-slate-300">
          <thead className="tw-text-xs tw-uppercase tw-bg-slate-100 dark:tw-bg-slate-900 dark:tw-text-slate-400">
            <tr>
              <th className="tw-px-6 tw-py-3">Cliente</th>
              <th className="tw-px-6 tw-py-3">Email</th>
              <th className="tw-px-6 tw-py-3">Presupuesto</th>
              <th className="tw-px-6 tw-py-3">Asunto</th>
              <th className="tw-px-6 tw-py-3">Último envio</th>
              <th className="tw-px-6 tw-py-3">Número Reenvio</th>
            </tr>
          </thead>
          <tbody>
            {loading ? (
              <Placeholder columnas={6} />
            ) : datos.length === 0 ? (
              <tr>
                <td colSpan="8">
              ...
              datos.map((dato) => {
                return (
                  ...
                  >
                    <td className={`tw-px-6 tw-py-4 tw-font-bold`}></td>
