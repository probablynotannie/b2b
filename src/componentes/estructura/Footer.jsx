...
function Footer() {
  return (
    <footer className="flex flex-col items-center justify-center w-full pt-4 pb-6 font-semibold shadow-inner bg-muted dark:bg-primary min-h-[8vh]">
      <div className="grid w-full px-6 gap-y-4 md:gap-y-0 md:grid-cols-3">
        ...
        <div className="flex justify-center gap-2 md:justify-end">
          ...
          <li className="bg-black  rounded-full text-white w-8 h-8 flex justify-center items-center hover:scale-110 transition">
