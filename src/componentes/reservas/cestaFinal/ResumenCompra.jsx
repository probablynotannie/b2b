...
function ResumenCompra({
  ...
  return (
    <div className="col-span-2  shadow-xl border-2 border-slate-200 dark:border-slate-800 rounded-xl">
      <div className="p-5 border-b-2 dark:border-slate-700 bg-slate-700 dark:bg-slate-900 rounded-t-xl">
      ...
      <div className="p-5 space-y-6 bg-white dark:bg-slate-800">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-y-10 md:gap-10 ">
          <div className="flex items-center justify-center flex-col md:text-center text-sm text-slate-400 dark:text-secondary font-semibold">
