    ...
    <article className="mt-10 shadow-lg hover:shadow-xl transition duration-300 border dark:bg-slate-800 bg-slate-50 p-5 border-slate-200 dark:tw-border-slate-700  rounded-lg">
      ...
      <div className="grid md:grid-cols-3 gap-5">
        {actividades.map((actividad, index) => (
          <section
            key={index}
            className="pb-20 bg-white duration-300 dark:bg-slate-900 h-auto max-w-full rounded-lg rounded-t-lg  shadow transition relative dark:tw-border-2 dark:tw-border-slate-700"
          >
