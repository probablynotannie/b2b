...
const DropdownCheckboxSelector = ({ minPrice, maxPrice }) => {
  return (
    <div className="bg-white px-10 py-10 rounded-lg shadow-lg border-2 border-slate-100 relative">
      <h6 className="font-bold text-lg text-secondary absolute -top-5 bg-white p-2 px-5 border-2 border-slate-200 rounded-lg shadow-xl">
        Filtrado
      </h6>
