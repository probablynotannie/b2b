...
function Productos() {
  ...
  return (
    <main className="flex justify-center flex-col items-center mb-10">
      ...
      >
        <div className="bg-indigo-400 dark:bg-black text-pink-600  tw-bg-opacity-45 dark:bg-opacity-45 absolute top-0 left-0 w-full h-full pointer-events-none"></div>
        <div className="flex">
