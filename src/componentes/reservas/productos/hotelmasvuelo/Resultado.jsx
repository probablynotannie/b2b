      ...
      <div className="w-full">
        ...
        >
          ...
          <div className="flex">
            ...
            <aside className="lg:hidden col-span-9 lg:col-span-3 h-fit lg:sticky top-16 lg:bg-slate-100 lg:dark:bg-slate-800 lg:border-2 border-slate-200  dark:tw-border-slate-800 rounded-lg lg:shadow-xl hover:lg:shadow-2xl transition px-3 lg:p-3 lg:pb-10">
              <Aside />
            </aside>
          </div>
        </div>
        ...
        <article className="grid grid-cols-9 lg:gap-8 xs:gap-28 container">
          {activeTab === "Resultados" && (
            <>
              <aside className="hidden lg:block col-span-9 lg:col-span-3 h-fit lg:sticky top-16 lg:bg-slate-100 lg:dark:bg-slate-800 lg:border-2 border-slate-200  dark:tw-border-slate-800 rounded-lg lg:shadow-xl hover:lg:shadow-2xl transition px-3 lg:p-3 lg:pb-10">
                <Aside />
              </aside>
