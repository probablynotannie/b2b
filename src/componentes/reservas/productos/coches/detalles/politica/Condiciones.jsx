  ...
  return (
    <div>
      <div className="flex justify-between">
        ...
        <MdCarRental className="text-2xl text-slate-700 dark:tw-text-slate-300 " />
      </div>
      <div className="max-w-7xl mx-auto bg-white dark:bg-slate-900 shadow-md rounded-lg p-8">
        <h1 className="text-2xl font-bold text-slate-700 dark:tw-text-slate-300  mb-6">
          Drivalia España - Documentación Necesaria
        </h1>

        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-700 dark:tw-text-slate-300 ">
          ...
          <p className="mt-2 text-red-600 dark:tw-text-red-700 font-semibold">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mt-2 text-red-600 dark:tw-text-red-700">
            <li>Cheques</li>
            <li>Efectivo</li>
        ...
        <footer className="mt-10 text-center text-gray-600 dark:tw-text-slate-500 text-sm">
          <p>
