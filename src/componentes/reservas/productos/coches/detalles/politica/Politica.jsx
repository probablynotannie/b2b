  ...
  return (
    <div>
      <div className="flex justify-between">
        ...
        <FaExclamation className="text-xl text-secondary" />
      </div>
      <p>
      ...
      <ul className="flex flex-col gap-4 mt-3">
        <li>
          ...
          CWAR, MTMR, MTAR -{" "}
          <span className="font-semibold text-secondary"> 1250.00</span>
        </li>
        <li>
          ...
          <span className="font-semibold text-secondary"> 2000.00EUR </span>
        </li>
        <li>
          JS (LFAV), LFAV -{" "}
          <span className="font-semibold text-secondary"> 3000.00 EUR</span>
        </li>
      </ul>
    </div>
  );
