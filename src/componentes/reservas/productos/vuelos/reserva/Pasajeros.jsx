    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-10">
        {pasajeros.map((pasajero, index) => (
          <div
            key={index}
            className="border border-slate-200 dark:border-slate-700 dark:bg-slate-800 mt-5 flex"
          >
            <div className="w-1/5 bg-secondary dark:bg-slate-900 text-3xl text-white flex items-center justify-center h-full">
              <FaUser />
            </div>
            <div className="p-3">
