  ...
  return (
    <>
      <section>
        {cesta === true ? (
          ...
          <>
            ...
            <img
              src={producto.img}
              alt="imagen producto"
              className="tw-w-full tw-h-[30vh] tw-object-top tw-object-cover tw-my-3 tw-rounded"
            />
          </>
        )}
        ...
        {producto.importante && (
          <div className="tw-bg-red-50 tw-p-2 tw-rounded tw-mt-5">
            <h2 className="tw-uppercase tw-font-bold tw-text-red-500">
              Importante
            </h2>
