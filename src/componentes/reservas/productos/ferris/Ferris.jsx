    ...
    <div className="container mx-auto px-4 py-6">
      ...
      {ferris.map((ferrySet) => (
        <div key={ferrySet.id} className="mb-6 border rounded-lg shadow">
          <h3 className="p-4 bg-gray-200 text-lg font-semibold">
            Tarifa: {ferrySet.tarifa.toUpperCase()} - Cambios:{" "}
            {ferrySet.cambios ? "Permitidos" : "No Permitidos"} - Cancelaciones:{" "}
            {ferrySet.cancelaciones ? "Permitidas" : "No Permitidas"}
          </h3>

          <div className="p-4">
            <h4 className="text-md font-bold mb-2">Ida: {ferrySet.ida.ruta}</h4>
