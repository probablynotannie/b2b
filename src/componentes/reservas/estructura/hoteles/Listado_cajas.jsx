        ...
        {habitaciones.map((habitacion) => (
          ...
          >
            ...
            {seleccion === "seleccionar" ? (
              <button
                className="tw-absolute -tw-bottom-6 tw-left-1/2 tw-transform -tw-translate-x-1/2 tw-btn tw-font-semibold tw-border-2 tw-border-white tw-p-3 tw-px-7 tw-rounded-lg tw-transition group-hover:shadow-xl"
                onClick={() => {
              ...
              <Link to={"/datosHotel"} state={{ producto, habitacion }}>
                <button className="tw-absolute -tw-bottom-6 tw-left-1/2 tw-transform -tw-translate-x-1/2 tw-btn tw-font-semibold tw-border-2 tw-border-white tw-p-3 tw-px-7 tw-rounded-lg tw-transition group-hover:shadow-xl">
                  {habitacion.precio}€
                </button>
              </Link>
            )}
