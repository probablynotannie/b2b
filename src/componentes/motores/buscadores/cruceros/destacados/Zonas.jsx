...
function Zonas({ isLoading, data, setRequestData }) {
  ...
  const handleZoneClick = (producto) => {
    ...
    const enlace = "/idZona/" + producto.id_zona_destino;
  ...
  return (
    <div className="tw-h-full tw-flex tw-flex-col">
      {!isLoading && zonasDestacadas.length > 0 && (
        <>
          ...
          <div className="tw-grid md:tw-grid-cols-2 xl:tw-grid-cols-1 tw-gap-3 tw-mt-3">
            {zonasDestacadas.map((zona, index) => (
