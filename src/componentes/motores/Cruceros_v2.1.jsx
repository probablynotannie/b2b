  ...
  return (
    <article className="tw-grid tw-grid-cols-10 tw-gap-10 lg:tw-px-20 lg:tw-py-10">
      ...
      <div className="w-col-span-10 lg:tw-col-span-7 xl:tw-col-span-8  tw-flex-col">
        <div className="tw-relative tw-bg-white tw-rounded-lg  tw-shadow-md hover:tw-shadow-xl tw-border-2 tw-border-slate-200 tw-mb-10 dark:tw-bg-slate-900 dark:tw-bg-opacity-55 tw-bg-opacity-80  tw-p-4 tw-pb-10">
          <form>
