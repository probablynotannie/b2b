...
import Puertos from "./destacados/crucerosv3/Puertos2";
import Zonas from "./destacados/crucerosv3/Zonas2";
...
function Cruceros() {
  ...
  return (
    <article className="tw-flex-grow">
      ...
      <div className=" tw-gap-10 tw-mt-16 tw-container">
        <h1 className="tw-font-bold tw-text-3xl">Destacados</h1>
