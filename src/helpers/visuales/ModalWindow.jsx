...
function ModalWindow({ show, onClose, titulo, subTitulo, body, botones }) {
  return (
    ...
    >
      ...
      <Modal.Footer className="dark:tw-bg-slate-900 tw-border tw-border-t-slate-100 dark:tw-border-t-slate-700 tw-border-secondary tw-flex tw-items-center tw-pap-2">
        {botones && botones}
        <button
